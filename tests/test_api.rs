...
use fm_index::{
    converter::DefaultConverter, FMIndex, FMIndexWithLocate, HeapSize, RLFMIndex,
...
fn test_fm_index_backend_trait_fm_index_suffix_array() {
    let index = FMIndexWithLocate::new("text\0".as_bytes(), DefaultConverter::<u8>::default(), 2);
...
fn test_fm_index_backend_trait_fm_index_count_only() {
    let index = FMIndex::new("text\0".as_bytes(), DefaultConverter::<u8>::default());
...
fn test_fm_index_backend_trait_rlfm_index_suffix_array() {
    let index = RLFMIndexWithLocate::new("text\0".as_bytes(), DefaultConverter::<u8>::default(), 2);
...
fn test_fm_index_backend_trait_rlfm_index_count_only() {
    let index = RLFMIndex::new("text\0".as_bytes(), DefaultConverter::<u8>::default());
